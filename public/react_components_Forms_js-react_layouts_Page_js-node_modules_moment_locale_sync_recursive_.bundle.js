(self["webpackChunkad_manager"] = self["webpackChunkad_manager"] || []).push([["react_components_Forms_js-react_layouts_Page_js-node_modules_moment_locale_sync_recursive_"],{
...
const Forms = ({
  ...
  const updateAdInitialValues = {
    ...
    image: "",
    link: ad ? ad.link : "",
    start: ad ? moment__WEBPACK_IMPORTED_MODULE_9___default()(ad.start).toDate() : "",
    end: ad ? moment__WEBPACK_IMPORTED_MODULE_9___default()(ad.end).toDate() : ""
  };
  ...
  const submitAddAd = (values, {
    ...
    (async () => {
      let start = moment__WEBPACK_IMPORTED_MODULE_9___default()(values.start).format('YYYY/MM/DD');
      let end = moment__WEBPACK_IMPORTED_MODULE_9___default()(values.end).format('YYYY/MM/DD');
  ...
  const submitUpdateAd = (values, {
    ...
    (async () => {
      let start = luxon__WEBPACK_IMPORTED_MODULE_10__.DateTime.fromJSDate(values.start).toFormat('yyyy/MM/dd');
      let end = luxon__WEBPACK_IMPORTED_MODULE_10__.DateTime.fromJSDate(values.end).toFormat('yyyy/MM/dd');
      const data = new FormData();
      data.append('slot_id', values.slot);
      data.append('title', values.title);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(formik__WEBPACK_IMPORTED_MODULE_4__.Formik, {
    ...
    for: "slot"
  }, "Slot"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_select__WEBPACK_IMPORTED_MODULE_11__["default"], {
    name: "slot",
    id: "slot",
    ...
    for: "image"
  }, "Image"), values.image && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    style: {
      width: '100%',
      height: 200,
    ...
    for: "start"
  }, "Start Date"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement((react_datepicker__WEBPACK_IMPORTED_MODULE_12___default()), {
    className: "form-control",
    ...
    for: "end"
  }, "End Date"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement((react_datepicker__WEBPACK_IMPORTED_MODULE_12___default()), {
    className: "form-control",
    selected: values.end,
    ...
    name: "slot",
    id: "slot",
    value: getSlotDetails(values.slot),
    onChange: slot => setFieldValue('slot', slot.value),
    onBlur: () => setFieldTouched('slot', true),
    options: options
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(formik__WEBPACK_IMPORTED_MODULE_4__.ErrorMessage, {
    ...
    src: values.image ? URL.createObjectURL(values.image) : `data:${ad.type};base64, ${ad.image}`,
    style: {
      maxWidth: '100%',
      maxHeight: '100%'
    }
    ...
    initialValues: deleteAdInitialValues,
    enableReinitialize: true,
    validationSchema: null,
    onSubmit: submitDeleteAd
  }, formik => {
    const {
      values,
      handleChange,
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(formik__WEBPACK_IMPORTED_MODULE_4__.Form, {
      ...
      onSubmit: handleSubmit,
      onCancel: resetForm
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "This advert will be permanently deleted."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: "row row-sm mg-b-10"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: "col-sm-12"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ApiErrors__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
//# sourceMappingURL=react_components_Forms_js-react_layouts_Page_js-node_modules_moment_locale_sync_recursive_.bundle.js.map